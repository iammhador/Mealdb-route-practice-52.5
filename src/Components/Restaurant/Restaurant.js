...
const Restaurant = () => {
  return (
    <div>
      <h1 className="text-center text-2xl font-bold text-rose-700 my-5">
        This Is Restaurant Card Section
      </h1>

      <div className="grid grid-cols-3 justify-items-center my-5 mx-5 py-5 px-5 ">
        <div class="w-full max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
          ...
          <div class="flex flex-col items-center pb-10">
            <img
              ...
              src="https://cdn-icons-png.flaticon.com/512/5307/5307440.png"
              alt="Bonnie image"
            />
